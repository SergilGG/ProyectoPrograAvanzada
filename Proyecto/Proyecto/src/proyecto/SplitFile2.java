...
public class SplitFile2 {
    ...
    public static int getNumberLines(String path, String fileName) {
        ...
        File fileToCountLines = new File(path, fileName);

        /*try (BufferedReader reader = new BufferedReader(new FileReader(fileToCountLines))) {
    ...
    public static int Split(String path, String fileName){
       ...
       int finalNumFiles = copyContent(path, fileName, 32*CPUs );
    ...
    public static int copyContent(String path, String fileName, int numFiles ){
        System.out.println("Copiado contenido : ");
        //Get number of lines of file countLines
        ...
        try {
            ...
            while ((linea = sourceFile.readLine()) != null){
                for (int k = 1; k <= tmpNumFiles; k++) {
                 //   System.out.println("Copiado contenido file : " + k);
